            ...
            <div className="relative z-10 w-full max-w-lg px-6">
                <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-lg shadow-2xl p-8 max-h-[90vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            disabled={isLoading}
                            className={`w-full py-3 text-lg font-medium flex items-center justify-center gap-2 ${isLoading ? 'opacity-60 cursor-not-allowed': ''} bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors`}
                            type="submit"
                        >
                            {isLoading ? (
                                <>
